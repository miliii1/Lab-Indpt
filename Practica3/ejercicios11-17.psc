...
Algoritmo eje15
	...
	FinSi
FinAlgoritmo
// 16) Se ingresa un número natural del 1 al 7, el programa devuelve el nombre del
// día de la semana al cual corresponde. (Ej.: Si ingresa 1 debe devolver "lunes").

Algoritmo eje16
	Definir dia Como Entero
	Escribir "Ingrese un entero (1-7): "
	Leer dia
